...
import {
  ...
  GraduationCap, ArrowRight, X, Check, Zap
} from 'lucide-react'
...
export default function ProductsSection() {
  ...
  return (
    <section className="py-20 bg-[#0c2701] min-h-screen">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start justify-between p-5 pb-0">
                    ...
                    {product.soon ? (
                      <span className="px-2.5 py-1 rounded-full text-[9px] font-black uppercase tracking-widest bg-[#fbbf24]/10 text-[#fbbf24] border border-[#fbbf24]/20">
                        Soon
                      </span>
                    ) : (
                      <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[9px] font-black uppercase tracking-widest bg-[#81fa00]/8 text-[#81fa00] border border-[#81fa00]/20">
                  ...
                  <div className="flex items-center justify-between px-5 py-3.5 border-t border-[#81fa00]/6">
                    <span className="text-[10px] text-gray-700 uppercase tracking-[0.1em] font-semibold">{product.cat}</span>
                    <div
      ...
      <AnimatePresence>
        {selected && (
          <motion.div
            ...
            style={{ backgroundColor: 'rgba(6,23,1,0.88)', backdropFilter: 'blur(8px)' }}
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-md rounded-3xl border border-[#81fa00]/15 overflow-hidden"
              style={{ background: 'linear-gradient(135deg, #0a1b03 0%, #0c2701 100%)' }}
            >
              {/* Top glow */}
              <div
                className="absolute top-0 left-0 right-0 h-40 pointer-events-none"
                style={{ background: `radial-gradient(ellipse at 50% -20%, ${selected.accent}20, transparent 70%)` }}
              />
              ...
              <div className="relative flex items-center gap-3 p-6 border-b border-[#81fa00]/8">
                ...
                {selected.soon ? (
                  <span className="px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider bg-[#fbbf24]/10 text-[#fbbf24] border border-[#fbbf24]/20">
                    Coming Soon
                  </span>
                ) : (
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider bg-[#81fa00]/8 text-[#81fa00] border border-[#81fa00]/20">
              ...
              <div className="relative p-6 space-y-5">
                ...
                <div className="flex flex-wrap gap-2">
                  {selected.tags.map(tag => (
                    <span
                      key={tag}
                      className="px-3 py-1 rounded-full text-[11px] font-semibold text-gray-500 border border-[#81fa00]/10 bg-[#81fa00]/4"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                {/* Features */}
                <div className="bg-[#0c2701] rounded-2xl p-4 border border-[#81fa00]/8">
                  <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#81fa00]/50 mb-3">
                    Key Features
                  </p>
                  <div className="space-y-2.5">
                    {selected.results.map(r => (
                      <div key={r} className="flex items-center gap-2.5">
                        ...
                        >
                          <Check size={9} strokeWidth={3} style={{ color: selected.accent }} />
                        </div>
                ...
                <div className="flex gap-3 pt-1">
                  {selected.soon ? (
                    <button className="flex-1 px-5 py-3 rounded-full text-sm font-bold border border-[#81fa00]/15 text-gray-400 hover:text-[#81fa00] hover:border-[#81fa00]/30 transition-all duration-200">
                      Notify Me
                    </button>
                  ) : (
                    <>
                      <button
                        ...
                        className="flex-1 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-full text-sm font-black text-black transition-all duration-200 shadow-xl"
                        style={{
                          backgroundColor: selected.accent,
                          boxShadow: `0 0 24px ${selected.accent}35`,
                        }}
                      >
                        Explore {selected.name}
                        <ArrowRight size={14} />
                      </button>
                      <button className="px-5 py-3 rounded-full text-sm font-bold border border-[#81fa00]/15 text-gray-400 hover:text-[#81fa00] hover:border-[#81fa00]/30 transition-all duration-200">
                        Docs
                      </button>
                    </>
                  )}
